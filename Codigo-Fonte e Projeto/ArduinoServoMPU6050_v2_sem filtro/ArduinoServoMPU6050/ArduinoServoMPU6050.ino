...
double accYangle;
double accZangle;
//Usado para calcular el angulo - Variates del giroscopio
...
void setup() {
  ...
  // Inicializando a comunicacion serial
  // funciona en 8MHz o en 16MHz
  Serial.begin(38400);

  // Iniciando dispositivos
  Serial.println("Inicializando cominicacion I2C...");
  
  accelgyro.initialize();

  // Testando a conexion con MPU6050
  Serial.println("Testando la conexion con MPU6050...");
  Serial.println(accelgyro.testConnection() ? "MPU6050 conectada com sucesso" : "Fallo en la conexion con el MPU6050");
...
void loop() {
  // hazciendo la lectura de conexion con el MPU6050
  ...
  //###################### Calcular del angulo de giro sin cualquier filtro ######################### 
